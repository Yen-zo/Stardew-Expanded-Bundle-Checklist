    ...
    bundles: [
      {
        ...
        required: 4,
        items: [
          { id: "box1-m1-s1", name: "Wild Horseradish", season: [SEASONS.SPRING], amount: 1, image: "SVEITEMS/Spring_Foraging/Wild_Horseradish.png", tooltipText: "Foraging in Spring OR Spring Seeds (25%)", completed: false},
          { id: "box1-m1-s2", name: "Daffodil", season: [SEASONS.SPRING], amount: 1, image: "SVEITEMS/Spring_Foraging/Daffodil.png", tooltipText: "Foraging in Spring OR Spring Seeds (25%) OR Pierre's shop during Flower Dance", completed: false},
          { id: "box1-m1-s3", name: "Leek", season: [SEASONS.SPRING], amount: 1, image: "SVEITEMS/Spring_Foraging/Leek.png", tooltipText: "Foraging in Spring OR Spring Seeds (25%)", completed: false},
          { id: "box1-m1-s4", name: "Dandelion", season: [SEASONS.SPRING], amount: 1, image: "SVEITEMS/Spring_Foraging/Dandelion.png", tooltipText: "Foraging in Spring OR Spring Seeds (25%) OR Pierre's shop during Flower Dance", completed: false},
        ],
      },

      {
        ...
        required: 4,
        items: [
          { id: "box1-m2-s1", name: "Grape", season: [SEASONS.SUMMER, SEASONS.FALL], amount: 1, image: "SVEITEMS/Summer_Foraging/Grape.png", tooltipText: "Foraging in Summer OR Summer Seeds (33%) OR Grape Starter (Fall Crop)", completed: false},
          { id: "box1-m2-s2", name: "Spice Berry", season: [SEASONS.SUMMER], amount: 1, image: "SVEITEMS/Summer_Foraging/Spice_Berry.png", tooltipText: "Foraging in Summer OR Summer Seeds (33%) OR Fruit Bat Cave", completed: false},
          { id: "box1-m2-s3", name: "Sweet Pea", season: [SEASONS.SUMMER], amount: 1, image: "SVEITEMS/Summer_Foraging/Sweet_Pea.png", tooltipText: "Foraging in Summer OR Summer Seeds (33%)", completed: false},
          { id: "box1-m2-s4", name: "Red Baneberry", season: [SEASONS.SUMMER], amount: 1, image: "SVEITEMS/Summer_Foraging/Red_Baneberry.png", tooltipText: "Foraging in Secret Woods during Summer", completed: false},
        ],
      },

      {
        ...
        required: 5,
        items: [
          { id: "box1-m3-s1", name: "Common Mushroom", season: [SEASONS.FALL], amount: 1, image: "SVEITEMS/Fall_Foraging/Common_Mushroom.png", tooltipText: "Foraging in Fall OR Fall Seeds (25%)", completed: false},
          { id: "box1-m3-s2", name: "Wild Plum", season: [SEASONS.FALL], amount: 1, image: "SVEITEMS/Fall_Foraging/Wild_Plum.png", tooltipText: "Foraging in Fall OR Fall Seeds (25%)", completed: false},
          { id: "box1-m3-s3", name: "Hazelnut", season: [SEASONS.FALL], amount: 1, image: "SVEITEMS/Fall_Foraging/Hazelnut.png", tooltipText: "Foraging in Fall OR Fall Seeds (25%)", completed: false},
          { id: "box1-m3-s4", name: "Blackberry", season: [SEASONS.FALL], amount: 1, image: "SVEITEMS/Fall_Foraging/Blackberry.png", tooltipText: "Foraging in Fall OR Fall Seeds (25%)", completed: false},
          { id: "box1-m3-s5", name: "Mushroom Colony", season: [SEASONS.FALL], amount: 1, image: "SVEITEMS/Fall_Foraging/Mushroom_Colony.png", tooltipText: "Foraging in Fall (Secret Woods / West Cindersap / Jumino Woods)", completed: false},
        ],
      },

      {
        ...
        required: 5,
        items: [
          { id: "box1-m4-s1", name: "Winter Root", season: [SEASONS.WINTER], amount: 1, image: "SVEITEMS/Winter_Foraging/Winter_Root.png", tooltipText: "Foraging in Winter OR Winter Seeds (25%) OR Winter Tilling", completed: false},
          { id: "box1-m4-s2", name: "Crystal Fruit", season: [SEASONS.WINTER], amount: 1, image: "SVEITEMS/Winter_Foraging/Crystal_Fruit.png", tooltipText: "Foraging in Winter OR Winter Seeds (25%)", completed: false},
          { id: "box1-m4-s3", name: "Snow Yam", season: [SEASONS.WINTER], amount: 1, image: "SVEITEMS/Winter_Foraging/Snow_Yam.png", tooltipText: "Foraging in Winter OR Winter Seeds (25%) OR Winter Tilling", completed: false},
          { id: "box1-m4-s4", name: "Crocus", season: [SEASONS.WINTER], amount: 1, image: "SVEITEMS/Winter_Foraging/Crocus.png", tooltipText: "Foraging in Winter OR Winter Seeds (25%)", completed: false},
          { id: "box1-m4-s5", name: "Bearberry", season: [SEASONS.WINTER], amount: 1, image: "SVEITEMS/Winter_Foraging/Bearberry.png", tooltipText: "Foraging in Secret Woods during Winter", completed: false},
        ],
      },

      {
        ...
        required: 4,
        items: [
          { id: "box1-m5-s1", name: "Wood", season: [SEASONS.ANY], amount: 499, image: "SVEITEMS/Construction/Wood.png", tooltipText: "Chopping trees OR Crates in mines", completed: false},
          { id: "box1-m5-s2", name: "Clay", season: [SEASONS.ANY], amount: 10, image: "SVEITEMS/Construction/Clay.png", tooltipText: "Tilling ground", completed: false},
          { id: "box1-m5-s3", name: "Stone", season: [SEASONS.ANY], amount: 199, image: "SVEITEMS/Construction/Stone.png", tooltipText: "Mining rocks", completed: false},
          { id: "box1-m5-s4", name: "Hardwood", season: [SEASONS.ANY], amount: 30, image: "SVEITEMS/Construction/Hardwood.png", tooltipText: "Mahogany Trees OR Large Stumps/Logs OR Crates in mines", completed: false},
        ],
      },

      {
        ...
        required: 8,
        items: [
          { id: "box1-m6-s1", name: "Coconut", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Coconut.png", tooltipText: "Foraging in Calico Desert", completed: false},
          { id: "box1-m6-s2", name: "Cactus Fruit", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Cactus_Fruit.png", tooltipText: "Foraging in Calico Desert", completed: false},
          { id: "box1-m6-s3", name: "Cave Carrot", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Cave_Carrot.png", tooltipText: "Tilling in mines", completed: false},
          { id: "box1-m6-s4", name: "Red Mushroom", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Red_Mushroom.png", tooltipText: "Foraging in caves OR Secret Woods OR Mushroom Cave on Farm", completed: false},
          { id: "box1-m6-s5", name: "Purple Mushroom", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Purple_Mushroom.png", tooltipText: "Foraging in caves OR Mushroom Cave on Farm (rare)", completed: false},
          { id: "box1-m6-s6", name: "Fir Wax", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Fir_Wax.png", tooltipText: "Placing Tapper on Fir Tree OR Sold from Bear", completed: false},
          { id: "box1-m6-s7", name: "Birch Water", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Birch_Water.png", tooltipText: "Placing Tapper on Birch Tree OR Sold from Bear", completed: false},
          { id: "box1-m6-s8", name: "Pine Tar", season: [SEASONS.ANY], amount: 1, image: "SVEITEMS/Exotic_Foraging/Pine_Tar.png", tooltipText: "Placing Tapper on Pine Tree OR Sold from Bear", completed: false},
        ],
      },
    ],
  },
